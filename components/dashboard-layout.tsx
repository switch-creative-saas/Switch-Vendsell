  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300 flex">
      ...
      >
        ...
        <div className="p-6 border-b bg-muted transition-colors duration-300">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="font-semibold">Adunni Fashions</p>
              <p className="text-sm text-muted-foreground">adunnifashions.switch.store</p>
            </div>
          </div>
          <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <Badge className="bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200 hover:bg-blue-100">Pro Plan</Badge>
            <Link href="/store/preview" target="_blank" className="w-full sm:w-auto">
      ...
      <main className="flex-1 flex flex-col min-h-screen">
            ...
            <div className="flex items-center space-x-4">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-80">
                  <DropdownMenuItem>Order #1234 has been delivered</DropdownMenuItem>
                  <DropdownMenuItem>New customer signed up</DropdownMenuItem>
                  <DropdownMenuItem>Payment received: ₦25,000</DropdownMenuItem>
                  {/* Add more notifications or map from a list */}
                </DropdownMenuContent>
              </DropdownMenu>
              <DarkModeToggle />
              {/* User menu */}
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="flex items-center space-x-2">
                    ...
                    <span className="hidden md:block font-medium">Adunni Okafor</span>
                  </Button>
                </DropdownMenuTrigger>
        ...
        {/* Page content */}
        <div className="flex-1 p-3 sm:p-6 transition-colors duration-300 w-full">{children}</div>
      </main>

      {/* Mobile Sidebar Sheet */}
      {sidebarOpen && (
        <div className="fixed inset-0 z-50 flex lg:hidden">
          <div className="w-64 max-w-full h-full bg-card shadow-lg flex flex-col overflow-y-auto">
            <div className="flex items-center justify-between h-16 px-6 border-b bg-background/80 transition-colors duration-300">
              <Link href="/" className="flex items-center space-x-2">
                <div className="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center">
                  <span className="text-white font-bold text-sm">S</span>
